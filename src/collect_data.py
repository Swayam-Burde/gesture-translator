        ...
        while cap.isOpened():
            ...
            if results.hand_landmarks:
                for hand_landmarks in results.hand_landmarks:
                    ...
                    h, w, c = img.shape
                    landmarks = [(lm.x * w, lm.y * h, lm.z * w) for lm in hand_landmarks]
            ...
            cv2.putText(img, "Data Collection Mode", (10, 30), cv2.FONT_HERSHEY_SIMPLEX, 0.7, (0, 255, 0), 2)
            y_offset = 60
            for name, count in features_collected.items():
                cv2.putText(img, f"{name}: {count}", (10, y_offset), cv2.FONT_HERSHEY_SIMPLEX, 0.6, (255, 255, 0), 1)
                y_offset += 25
